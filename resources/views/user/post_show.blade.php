...
<div class="container-fluid position-relative p-0">
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">{{ $post->title }} - Detay Sayfası</h4>
            <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                <li class="breadcrumb-item"><a href="{{route('user.index')}}">Ana Sayfa</a></li>
                <li class="breadcrumb-item active text-primary">{{ $post->title }} - Detay</li>
            </ol>
        </div>
    </div>
    <!-- Header End -->
    ...
    <div class="container py-5">
        <div class="row g-4 align-items-stretch">
            ...
            <div class="col-md-6 wow fadeInLeft" data-wow-delay="0.2s">
                <img src="{{ $post->image_url ?? asset('user/img/default-post.jpg') }}"
            ...
            <div class="col-md-6 d-flex flex-column justify-content-center wow fadeInRight" data-wow-delay="0.4s">
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        <h6 class="mb-0">Yazar: {{ $post->user->name ?? 'Admin' }} {{ $post->user->surname ?? '' }}</h6>
                ...
                <!-- Sağda duran kibar buton -->
                <div class="d-flex justify-content-end mt-3">
                    <a class="btn btn-sm btn-outline-primary rounded-pill py-2 px-4" href="{{ route('user.post') }}">
                        Tüm Blogları Gör
                    </a>
                </div>
            </div>
