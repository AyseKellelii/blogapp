...
<div class="container-fluid position-relative p-0">
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">{{ $category->name }} Kategorisi</h4>
...
<div class="container-fluid service py-5">
    <div class="container py-5">
        <div class="text-center mx-auto pb-5" style="max-width: 800px;">
            <h1 class="display-5 mb-4">Bu kategorideki bloglar</h1>
        </div>
        ...
        <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="blog-item p-4 shadow-sm rounded bg-white h-100">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                <h6 class="mb-0">Yazar: {{ $post->user->name ?? 'Bilinmiyor' }} {{ $post->user->surname ?? '' }}</h6>
            ...
            @empty
                <div class="col-12 text-center">
                    <p>Bu kategoride henüz blog bulunmamaktadır.</p>
                </div>
            @endforelse
        </div>
    </div>
