...
<style>
    /* Navbar profil fotoğrafını sabitle */
    .navbar .dropdown-user .avatar img {
        ...
        border: 2px solid #fff; /* isteğe bağlı: beyaz çerçeve */
        box-shadow: 0 0 3px rgba(0, 0, 0, 0.1);
        overflow: hidden;
    }

    /* Navbar içindeki kapsayıcıyı düzgün hizala */
    ...
    /* Eğer fotoğraf yoksa placeholder ikon düzgün ortalansın */
    .navbar .dropdown-user .avatar i {
        font-size: 20px;
        color: #777;
    }

    /* Menü çizgilerini taşmasın */
    .navbar .dropdown-user .nav-link {
        padding: 0 !important;
        margin: 0 10px;
        height: 100%;
        display: flex;
              ...
              <span class="app-brand-logo demo">
                ...
                >
                  ...
                  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="app-brand-text demo menu-text fw-bolder ms-2">Blog Yönetimi</span>
                </a>
